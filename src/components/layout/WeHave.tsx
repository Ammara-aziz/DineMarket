...
const ProductComponent: React.FC<ProductProps> = ({ imageUrl, name, price }) => (
    <Link href="#">
        <div className="flex flex-col justify-center align-middle pt-8 mt-12 mb-16 pb-6 h-[400px] w-[338px] space-x-4 transition duration-500 hover:scale-125">
            <Image src={imageUrl} alt={name} className="w-[380px] h-[400px]" />
            <p className="flex justify-center font-semibold leading-6 mt-2 text-1.1rem tsracking-wide">{name}</p>
...
const WeHave = () => {
    const products = [
        ...
        { imageUrl: E5, name: 'Flex SweatPants', price: 175 },
        { imageUrl: E6, name: 'Pink Fleece Sweatpants', price: 195 },
        { imageUrl: E7, name: 'Lite Sweatpants', price: 150 },
        { imageUrl: E8, name: 'MuscleTank', price: 75 },
        { imageUrl: E9, name: 'Brushed Bomber', price: 225 },
        { imageUrl: Vent3, name: 'Raglan Sweatshirt', price: 195 },
    ];
                ...
                <div>
                    <Slider {...settings} >
                        {products.map((Product, id) => (
                            <ProductComponent key={id} {...Product} />
                        ))}
                    </Slider>
                </div>

                <section className='pt-16'>
                    <div className='flex flex-col font-extrabold leading-[49px] absolute pt-10 -bottom-[1750px] tracking-widest pl-[670px] text-4xl'>
                        Unique and <p> Authentic Vintage</p> Designer Jewellery
                    </div>
                    <div className=' pl-20 pr-20 bg-[#fbfcff] grid h-[884] w-[220] pt-24'>
                        ...
                        <div className=' grid grid-cols-2 gap-[2rem]'>
                            ...
                            <div className='w-[100%] z-[2]'>
                                <h3 className='font-semibold text-[1.125rem] leading-5 tracking-[0.03em] mb-[1rem] h-[426] w-[20]'>Using Good Quality Materials</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            </div>
                            <div className='w-[100%] z-[2]'>
                                <h3 className='font-semibold text-[1.125rem] leading-5 tracking-[0.03em] mb-[1rem] h-[426] w-[20]'>100% Handmade Products</h3>
                            ...
                            <div className='w-[100%] z-[2]'>
                                <h3 className='font-semibold text-[1.125rem] leading-5 tracking-[0.03em] mb-[1rem] h-[426] w-[20]'>Modern Fashion Design</h3>
                            ...
                            <div className='w-[100%] z-[2]'>
                                <h3 className='font-semibold text-[1.125rem] leading-5 tracking-[0.03em] mb-[1rem] h-[426] w-[20]'>Discount for Bulk Orders</h3>
                                <p className='block font-[300] leading-[22px] text-[1rem] text-[#212121] margin-block-start-[1em] margin-block-end-[1em]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
                            </div>
                        </div>
                        {/* right div */}
